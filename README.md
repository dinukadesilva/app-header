...
app-header 2.0.0+ makes use of several png files that are contained within the repository.  In order for the images to
render in your application, you must store them two folders up from the root of your application in a folder called images.  
This is a temporary solution until we are able to store our static assets in a permanent location.
