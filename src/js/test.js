              ...
              elementOpen("div", null, ["class", "o-dropdown-menu o-dropdown-menu--right o-app-header__menu-menu"])
                ...
                elementOpen("ul", null, ["class", "o-dropdown-menu__menu-items", "role", "menu", "aria-labelledby", "o-app-header-user-menu-label"])
                  elementOpen("li")
                    ...
                    elementClose("h2")
                    elementOpen("button", null, ["class", "o-dropdown-menu__menu-close"])
                      elementOpen("svg", null, ["role", "img", "aria-labelledby", "r2", "focusable", "false", "class", "pe-icon--remove-sm-24"])
                        elementOpen("title", null, ["id", "r2"])
                          text("Close dropdown menu")
                        elementClose("title")
                        elementOpen("use", null, ["xlink:href", "#remove-sm-24"])
                        elementClose("use")
                      elementClose("svg")
                    elementClose("button")
                  elementClose("li")
